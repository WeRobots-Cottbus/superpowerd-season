...
def run():
    ...
    MotorArm.run_angle(None,None)#speed, angle raus um die einheite mit zu nehmen und die hand zulösen
    GyroDrive(None, None, 90, 7)#fahrt bis kurz richtung öl
    MotorArm.run_angle(None, None)#arm wieder rein damit wir nicht hängen beleiben
